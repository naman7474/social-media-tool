...
_ALLOWED_POST_TRANSITIONS = {
    ...
    PostStatus.APPROVED: {PostStatus.POSTED, PostStatus.SCHEDULED, PostStatus.FAILED, PostStatus.CANCELLED},
    PostStatus.SCHEDULED: {PostStatus.APPROVED, PostStatus.POSTED, PostStatus.FAILED, PostStatus.CANCELLED},
